...
def test_the_slice_labels_red_team_logons_and_reports_what_it_could_not_match():
    lines = [
        ...
        auth_line(3 * DAY + 15, "U5@DOM1", "U5@DOM1", "C17693", "C77", result="Fail"),  # red-team source, benign
        auth_line(3 * DAY + 16, "U5@DOM1", "U5@DOM1", "C305", "C305"),           # other source, sampled out
    ...
    assert result["records"][1] == {"source_id": "C77", "event_id": "L4", "event_ts": float(3 * DAY + 15),
                                    "event_type": "auth_failure", "src_ip": "C17693", "ssh_user": "U5@DOM1"}
    assert result["red_team_sources"] == ["C17693"]
